...
urlpatterns = [
    ...
    path("get-availabel-subs", GetAvailabelSubs.as_view(), name="get_availabel_subs"),
    path("inquiry_insurance", InquiryInsuranceView.as_view(), name="inquiry_insurance"),
    path("inquiry/<code>", InquiryResults.as_view(), name="inquiry_results"),
