...
handler404 = SystemView.as_view(
    template_name="errors/pages_misc_error.html", status=404
)
handler403 = SystemView.as_view(
    template_name="errors/pages_misc_not_authorized.html", status=403
)
handler400 = SystemView.as_view(
    template_name="errors/pages_misc_error.html", status=400
)
handler500 = SystemView.as_view(
    template_name="errors/pages_misc_error.html", status=500
)
